...
//by jesse stone
template<typename Type>
CL_Mat4<Type> &CL_Mat4<Type>::operator =(const CL_Mat4<Type> &copy)
{
	matrix[0*4 + 0] = copy.matrix[0*4 + 0];
	matrix[0*4 + 1] = copy.matrix[0*4 + 1];
	matrix[0*4 + 2] = copy.matrix[0*4 + 2];
	matrix[0*4 + 3] = copy.matrix[0*4 + 3];
	matrix[1*4 + 0] = copy.matrix[1*4 + 0];
	matrix[1*4 + 1] = copy.matrix[1*4 + 1];
	matrix[1*4 + 2] = copy.matrix[1*4 + 2];
	matrix[1*4 + 3] = copy.matrix[1*4 + 3];
	matrix[2*4 + 0] = copy.matrix[2*4 + 0];
	matrix[2*4 + 1] = copy.matrix[2*4 + 1];
	matrix[2*4 + 2] = copy.matrix[2*4 + 2];
	matrix[2*4 + 3] = copy.matrix[2*4 + 3];
	matrix[3*4 + 0] = copy.matrix[3*4 + 0];
	matrix[3*4 + 1] = copy.matrix[3*4 + 1];
	matrix[3*4 + 2] = copy.matrix[3*4 + 2];
	matrix[3*4 + 3] = copy.matrix[3*4 + 3];
	return *this;
}
