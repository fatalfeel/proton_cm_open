...
public:
    ...
    CL_UnknownSharedPtr get_variable(const std::string &name);
...
public:
    ...
    void set_variable(const std::string &name, CL_UnknownSharedPtr ptr);
...
protected:
    ...
    std::map<std::string, CL_UnknownSharedPtr> data;
