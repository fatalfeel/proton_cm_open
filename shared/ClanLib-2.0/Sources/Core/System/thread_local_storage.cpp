...
CL_UnknownSharedPtr CL_ThreadLocalStorage::get_variable(const std::string &name)
{
#ifdef WIN32
	//if (cl_core_global.cl_tls_index == TLS_OUT_OF_INDEXES)
...
void CL_ThreadLocalStorage::set_variable(const std::string &name, CL_UnknownSharedPtr ptr)
{
#ifdef WIN32
	//if (cl_core_global.cl_tls_index == TLS_OUT_OF_INDEXES)
	//	throw CL_Exception("No CL_ThreadLocalStorage object created for this thread.");
