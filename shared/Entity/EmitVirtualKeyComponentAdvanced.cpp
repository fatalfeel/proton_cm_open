...
void EmitVirtualKeyComponentAdvanced::OnAdd(Entity *pEnt)
{
	...
	GetParent()->GetFunction("OnOverEnd")->m_sig_function.connect(1, boost::bind(&EmitVirtualKeyComponentAdvanced::OnOverEnd, this, _1));
	GetParent()->GetFunction("OnOverStart")->m_sig_function.connect(1, boost::bind(&EmitVirtualKeyComponentAdvanced::OnOverStart, this, _1));
	//GetParent()->GetFunction("OnOverMove")->m_sig_function.connect(1, boost::bind(&EmitVirtualKeyComponentAdvanced::OnOverStart, this, _1));
