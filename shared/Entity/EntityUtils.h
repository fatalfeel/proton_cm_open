...
Entity * EnableEntityButtonByName(const string &entityName, Entity *pRootEntity = Entity::GetEntityManager()); //TODO: Too much duplicated code with below
Entity * DisableEntityButtonByName(const string &entityName, Entity *pRootEntity = Entity::GetEntityManager());
...
//EntityComponent * TypeTextLabelEntity(Entity *pEnt, int delayBeforeActionMS = 0, uint32 textTypeSpeedMS = 50, TyperComponent::eMode = TyperComponent::MODE_ONCE_AND_REMOVE_SELF, string textToAddByTyping = "");
...
Entity * SetTextEntityByName(const string &entityName, string text, Entity *pRootEntity = Entity::GetEntityManager());
