...
void TemplateComponent::OnAdd(Entity *pEnt)
{
	...
	*/
	...
	GetParent()->GetFunction("OnRender")->m_sig_function.connect(1, boost::bind(&TemplateComponent::OnRender, this, _1));
	GetParent()->GetFunction("OnUpdate")->m_sig_function.connect(1, boost::bind(&TemplateComponent::OnUpdate, this, _1));
}
