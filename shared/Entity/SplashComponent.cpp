...
Entity * SplashComponent::ActivateSplash(SplashScreenItem &item)
{
	...
	pImage->GetFunction("OnButtonSelected")->m_sig_function.connect(pBG->GetFunction("OnDelete")->m_sig_function);
	return pBG;
}
...
void SplashComponent::OnAdd(Entity *pEnt)
{
	...
	*/
	...
	GetParent()->GetFunction("OnRender")->m_sig_function.connect(1, boost::bind(&SplashComponent::OnRender, this, _1));
	GetParent()->GetFunction("OnUpdate")->m_sig_function.connect(1, boost::bind(&SplashComponent::OnUpdate, this, _1));
}
