...
/////////////////////////by stone
extern unzFile ZEXPORT unzOpen2_mem (buf, size)
    unsigned char* buf;
	int size;
{
    unz_s us;
    ...
    us.filestream= (*(us.z_filefunc.zopen_mem))(us.z_filefunc.opaque,
                                                buf,
                                                size);
    if (us.filestream==NULL)
        return NULL;
...
extern unzFile ZEXPORT UnZipOpen_Memory (buf, size)
    unsigned char* buf;
	int size;
{
    return unzOpen2_mem(buf, size);
}
