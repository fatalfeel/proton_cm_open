...
public:
	...
	boost::signal<void (VariantList*)> m_sig_function;
};
	...
	typedef boost::unordered_map<string, FunctionObject*> functionList;
		...
		#endif //#if defined RT_WEBOS_ARM || ANDROID_NDK 

	#endif //#if defined( __APPLE__) || defined(RTLINUX)|| ANDROID_NDK || defined(PLATFORM_FLASH)
