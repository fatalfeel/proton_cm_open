...
static ResourceManager*  resource_manager_instance = NULL;

ResourceManager* ResourceManager::GetResourceManager()
{
	if (!resource_manager_instance)
		resource_manager_instance = new ResourceManager;
...
void ResourceManager::Free()
{
	if( resource_manager_instance )
	{
		...
		resource_manager_instance = NULL;
	}
}
