...
void Gamepad::ConnectToArcadeComponent( ArcadeInputComponent *pComp, bool bSendButtonEvents, bool bSendPadEventsAsFourDirections )
{
	...
	if (m_pArcadeComp)
	{
		...
		m_pArcadeComp->GetFunction("OnDelete")->m_sig_function.disconnect(boost::bind(&Gamepad::OnArcadeCompDestroyed, this, _1));
		m_pArcadeComp = NULL;
	}
	...
	if (bSendPadEventsAsFourDirections)
	{
		...
		pComp->GetFunction("OnDelete")->m_sig_function.connect(1, boost::bind(&Gamepad::OnArcadeCompDestroyed, this, _1));
	}
}
