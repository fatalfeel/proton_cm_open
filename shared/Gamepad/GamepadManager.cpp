...
//by jesse stone
static GamepadManager* gamepad_manager_instance = NULL;

GamepadManager* GamepadManager::GetGamepadManager()
{
	if (!gamepad_manager_instance)
		gamepad_manager_instance = new GamepadManager;
	return gamepad_manager_instance;
}
...
void GamepadManager::Free()
{
	if( gamepad_manager_instance )
	{
		delete gamepad_manager_instance;
		gamepad_manager_instance = NULL;
	}
}
