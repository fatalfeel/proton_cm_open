...
bool GamepadiCade::Init()
{
	...
	BaseApp::GetBaseApp()->m_sig_raw_keyboard.connect(1, boost::bind(&GamepadiCade::OnRawKeyboardInput, this, _1));
	BaseApp::GetBaseApp()->m_sig_hardware.connect(1, boost::bind(&GamepadiCade::OnHardwareMessage, this, _1));
...
void GamepadiCade::OnHardwareMessage( VariantList *pVList )
{
	...
	GamepadProvideriCade *pProvider = (GamepadProvideriCade*) GamepadManager::GetGamepadManager()->GetProviderByName("iCade");
