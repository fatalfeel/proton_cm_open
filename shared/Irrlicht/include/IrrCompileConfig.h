...
#endif //#if defined(_IRR_WINDOWS_API_) && (!defined(__GNUC__) || defined(IRR_COMPILE_WITH_DX9_DEV_PACK))
...
//#ifdef NO_IRR_COMPILE_WITH_RTTEX_LOADER_
//#undef _IRR_COMPILE_WITH_RTTEX_LOADER_
//#endif
...
#ifdef NO__IRR_COMPILE_WITH_PROTON_ARCHIVE_LOADER_
#undef __IRR_COMPILE_WITH_PROTON_ARCHIVE_LOADER_
#endif
