...
//by stone
        ...
        case video::EDT_OGLES1:
		{
			...
			VideoDriver = video::createOGLES1Driver(CreationParams, data, FileSystem, &IrrIPhoneDevice);
		}
	#else
        ...
        {
            video::SExposedVideoData data;
            VideoDriver = video::createOGLES2Driver(CreationParams, data, FileSystem, &IrrIPhoneDevice);
        }
#else
