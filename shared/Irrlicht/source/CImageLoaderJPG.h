...
private:
	...
	*/
	...
	static void Irr_init_source (j_decompress_ptr cinfo);
	...
	static boolean Irr_fill_input_buffer (j_decompress_ptr cinfo);
	...
	static void Irr_skip_input_data (j_decompress_ptr cinfo, long num_bytes);
