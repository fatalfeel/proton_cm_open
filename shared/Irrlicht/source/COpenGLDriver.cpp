...
: CNullDriver(io, params.WindowSize), COpenGLExtensionHandler(),
    ...
    HDc(0), Window(params.WindowId), Win32Device(device), //by stone
...
// METHODS
// -----------------------------------------------------------------------
//bool COpenGLDriver::genericDriverInit()//SETH
	...
	io::IFileSystem* io, CIrrDeviceWin32* device)
{
	...
	if (!ogl->initDriver(params, device))//SETH
	{
		ogl->drop();
		ogl = 0;
	}
