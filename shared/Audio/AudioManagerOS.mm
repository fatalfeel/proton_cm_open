...
//#include <CoreAudio/CoreAudioTypes.h> //no need
...
//by jesse stone
static AudioManagerOS* audio_ios_manager_instance = NULL;

AudioManagerOS* AudioManagerOS::GetAudioManager()
{
	if (!audio_ios_manager_instance)
		audio_ios_manager_instance = new AudioManagerOS;
	return audio_ios_manager_instance;
}

void AudioManagerOS::Free()
{
	if( audio_ios_manager_instance )
	{
		delete audio_ios_manager_instance;
		audio_ios_manager_instance = NULL;
	}
}
