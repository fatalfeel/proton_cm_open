...
//by jesse stone
static AudioManagerFMOD* audio_fmod_manager_instance = NULL;

AudioManagerFMOD* AudioManagerFMOD::GetAudioManager()
{
	if (!audio_fmod_manager_instance)
		audio_fmod_manager_instance = new AudioManagerFMOD;
	return audio_fmod_manager_instance;
}

void AudioManagerFMOD::Free()
{
	if( audio_fmod_manager_instance )
	{
		delete audio_fmod_manager_instance;
		audio_fmod_manager_instance = NULL;
	}
}
