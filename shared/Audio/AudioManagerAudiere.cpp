...
//by jesse stone
static AudioManagerAudiere* audiere_win_manager_instance = NULL;

AudioManagerAudiere* AudioManagerAudiere::GetAudioManager()
{
	if (!audiere_win_manager_instance)
		audiere_win_manager_instance = new AudioManagerAudiere;
	return audiere_win_manager_instance;
}

void AudioManagerAudiere::Free()
{
	if( audiere_win_manager_instance )
	{
		delete audiere_win_manager_instance;
		audiere_win_manager_instance = NULL;
	}
}
