...
public:
	...
	void SetProjectionMatrix(CL_Mat4f mat)
	{
    ...
    //will return the total number of fingers currently touching the screen.
	int             GetTotalActiveTouches();
    
    //not really advised or needed, ignore this
	void            ResetTouches();
