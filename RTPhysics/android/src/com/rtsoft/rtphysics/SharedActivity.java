...
import com.rtsoft.rtphysics.SharedMultiTouchInput;
...
import com.rtsoft.rtphysics.BillingService.RequestPurchase;
import com.rtsoft.rtphysics.BillingService.RestoreTransactions;
import com.rtsoft.rtphysics.Consts.PurchaseState;
import com.rtsoft.rtphysics.Consts.ResponseCode;
...
class WrapSharedMultiTouchInput
{
   ...
   static 
   {
       try
	   {
          Class.forName("com.rtsoft.rtphysics.SharedMultiTouchInput");
       } 
	   catch (Exception ex) 
	   {
