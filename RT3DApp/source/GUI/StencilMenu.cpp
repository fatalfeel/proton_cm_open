...
#if defined(_IRR_COMPILE_WITH_OGLES2_) || defined(_IRR_COMPILE_WITH_OPENGL_)
...
#else
	s_node->setMaterialTexture(0, driver->getTexture((GetBaseAppPath()+"game/water.jpg").c_str()));
#endif
